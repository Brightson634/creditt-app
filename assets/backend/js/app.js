$(document).ready(function() {
    ...
    var stores_table = $('#stores_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/stores',
        columnDefs: [
    ...
    $(document).on('click', 'button.edit_brand_button', function() {
        $('div.stores_modal').load($(this).data('href'), function() {
            $(this).modal('show');
    ...
    try {
        ...
        var business_store_locations = $('#business_location_stores_table').DataTable({
            processing: true,
            serverSide: true,
            bPaginate: false,
            buttons: [],
        ...
        console.log(error , 'datatable errors')
    }
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.success == true) {
                                ...
                                business_store_locations.ajax.reload()
                            } else {
                                toastr.error(result.msg);
                            }
                        },
