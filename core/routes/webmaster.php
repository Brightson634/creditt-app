...
Route::prefix('webmaster')->name('webmaster.')->group(function () {
  ...
  Route::middleware(['auth:webmaster','setUser','checkIslocked','setTenant'])->group(function () {
    ...
    Route::get('/accounting/get-account-sub-types', [
      CoaController::class,
      'getAccountSubTypes'
    ]);
    Route::get('/accounting/get-account-details-types', [
      CoaController::class,
      'getAccountDetailsType'
    ]);
    Route::put('/accounting/update/{id}', [
      CoaController::class,
      'update'
    ]);
    Route::get('create-default-accounts', [
      CoaController::class,
      'createDefaultAccounts'
    ])->name('accounting.create-default-accounts');
    ...
    //budget
    Route::resource('budget', BudgetController::class)->except([
      'show',
      'edit',
      'update',
      'destroy'
    ...
    Route::get(
      ...
      [
        ReportController::class,
        'accountReceivableAgeingDetails'
      ]
    ...
    Route::post('transactions/save-map', [
      TransactionController::class,
      'saveMap'
    ]);
    Route::get('settings', [SettingsAccController::class, 'index']);
    Route::get('reset-data', [
      SettingsAccController::class,
      'resetData'
    ]);
    ...
    Route::delete('/expense/delete/{id}',    [ExpenseController::class, 'expenseDestroy'])->name('expense.destroy');
    ...
    Route::get('/accounttransfer/receipt/{id}',       [AccountTransferController::class, 'receipt'])->name('accounttransfer.receipt');
    ...
    Route::get('/accountdeposit/receipt/{id}',       [AccountDepositController::class, 'receipt'])->name('accountdeposit.receipt');
    ...
    Route::get('/accountwithdraw/receipt/{id}',       [WithdrawController::class, 'receipt'])->name('accountwithdraw.receipt');
    ...
    Route::get('/loan/repayments/index', [LoanPaymentController::class, 'loanRepaymentIndex'])->name('loan.repayments.index');
    // Members
