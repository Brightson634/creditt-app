            ...
            ->addColumn(
                ...
                function ($row) use ($only_shipments, $is_admin, $sale_type) {
                    ...
                    if ($row->type == 'sell') {
                        ...
                        if (!$only_shipments) {
                            ...
                            if (auth()->user()->can("sell.create")) {
                                $html .= '<li><a href="' . action('\App\Http\Controllers\SellController@duplicateSell', [$row->id]) . '"><i class="fas fa-copy"></i> ' . __("lang_v1.duplicate_sell") . '</a></li>
                                    ...
                                    <li><a href="' . action('\App\Http\Controllers\SellReturnController@add', [$row->id]) . '"><i class="fas fa-undo"></i> ' . __("lang_v1.sell_return") . '</a></li>
                        ...
                        $html .= '<li><a href="#" data-href="' . action('\App\Http\Controllers\SellController@viewMedia', ["model_id" => $row->id, "model_type" => "Modules\Accounting\Entities\Transaction", 'model_media_type' => 'shipping_document']) . '" class="btn-modal" data-container=".view_modal"><i class="fas fa-paperclip" aria-hidden="true"></i>' . __("lang_v1.shipping_documents") . '</a></li>';
                    }
