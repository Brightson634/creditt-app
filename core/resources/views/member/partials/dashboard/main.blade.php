...
<body class="az-body az-light">
    <!--sidebar-->
    @include('member.partials.dashboard.sidebar')
    <div class="az-content az-content-dashboard-six">
        <!--top nav bar-->
        @include('member.partials.dashboard.topbar')
        ...
        <!--footer-->
        @include('member.partials.dashboard.footer')
    </div><!-- az-content -->
...
<script src="{{ asset('assets/backend/dash/lib/pickerjs/picker.min.js') }}"></script> --}}
    ...
    @include('member.partials.notify')
