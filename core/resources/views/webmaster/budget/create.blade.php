...
<section class="content">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\Webmaster\BudgetController::class, 'store']),
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg">Submit</button>
            </div>
        </div>
    {!! Form::close() !!}
    @endcomponent
