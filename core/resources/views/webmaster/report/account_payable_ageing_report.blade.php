        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="box box-warning">
                <div class="box-header with-border text-center">
                    <h2 class="box-title">Account Payable Ageing Report (Summary)</h2>
                </div>
                <div class="box-body">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#location_id').change( function(){
            if($(this).val()) {
                window.location.href = "{{route('webmaster.accounting.account_payable_ageing_report')}}?location_id=" + $(this).val();
            } else {
                window.location.href = "{{route('webmaster.accounting.account_payable_ageing_report')}}";
            }
