         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="form-group row mt-4">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-theme" id="btn_assetgroup">Add Asset group</button>
                  </div>
               </div>
            </form>
         </div>
...
<script type="text/javascript">
   ...
   $("#assetgroup_form").submit(function(e) {
        e.preventDefault();
        $("#btn_assetgroup").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span> Adding');
