...
<div class="tab-content">
   <div class="tab-pane {{ $activeTab == 'tab1' ? 'show active' : '' }}" id="new_member">
      <div class="row">
         <div class="col-xl-12 mx-auto">
            <div class="card" >
               <div class="card-body">
                  ...
                  <div class="row mt-2">
                     <div class="col-sm-9">
                        <button type="submit" class="btn btn-primary btn-theme" id="btn_member">Add Member</button>
                     </div>
                  </div>
                  </form>
               </div>
   ...
   <!--manage members-->
   <div class="tab-pane {{ $activeTab == 'tab2' ? 'show active' : '' }}" id="manage_members">
       <div class="row">
         <div class="col-xl-12 mx-auto">
            <div class="card">
               <div class="card-body">
   ...
   <!--create an account-->
   <div class="tab-pane {{ $activeTab == 'tab3' ? 'show active' : '' }}" id="create_account">
       <div class="row">
         <div class="col-xl-12 mx-auto">
            <div class="card">
               <div class="card-body">
   ...
   <div class="tab-pane {{ $activeTab == 'tab4' ? 'show active' : '' }}" id="member_accounts">
      <div class="row">
         <div class="col-xl-12 mx-auto">
            <div class="card">
               <div class="card-body">
