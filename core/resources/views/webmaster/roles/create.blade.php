               ...
               <form action="#" method="POST" id="role_form">
                  ...
                  <div class="cardd card-body">
                     ...
                     <div class="form-row">
                        ...
                        <div class="mb-3 ml-3">
                           <div class="custom-control custom-checkbox">
                              <input type="checkbox" name="permission_id[]" class="custom-control-input permission-checkbox" id="{{ $permission->permission_name }}" value="{{ $permission->id }}" data-module="{{ $module->module_name }}">
...
<script type="text/javascript">
   $('.module-checkbox').change(function() {
      ...
      $("#role_form").submit(function(e) {
        e.preventDefault();
        $("#btn_role").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span> Creating');
