                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="system_name" class="form-control custom-form-control"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="company_name" class="form-control custom-form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="physical_location" class="form-control custom-form-control"
                                        id="physical_location" value="{{ $setting->physical_location }}">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="post_office" class="form-control custom-form-control"
                                        id="post_office" value="{{ $setting->post_office }}">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="phone_contact_one" class="form-control custom-form-control"
                                        id="phone_contact_one" value="{{ $setting->phone_contact_one }}">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="phone_contact_two" class="form-control custom-form-control"
                                        id="phone_contact_two" value="{{ $setting->phone_contact_two }}">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group custom-form-group">
                                    ...
                                    <input type="text" name="phone_contact_three"
                                        class="form-control custom-form-control" id="phone_contact_three"
                                        value="{{ $setting->phone_contact_three }}">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                        </div>
