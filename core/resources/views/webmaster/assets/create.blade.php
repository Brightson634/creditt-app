            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="#" method="POST" id="asset_form">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="staff_id" id="staff_id">
                                        ...
                                        @foreach ($staffs as $data)
                                            <option value="{{ $data->id }}">{{ $data->salutation }} {{ $data->fname }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="warrant_period" class="form-control" id="warrant_period"
                                        autocomplete="off">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="depreciation_period" class="form-label">Depreciation Period (in
                                        months)</label>
                                    <input type="text" name="depreciation_period" id="depreciation_period"
                                        class="form-control">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="depreciation_amount" id="depreciation_amount"
                                        class="form-control">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary btn-theme" id="btn_asset">Add
                                    Asset</button>
                            </div>
                        </div>
                    </form>
