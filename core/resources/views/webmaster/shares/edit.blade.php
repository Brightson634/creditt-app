            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  <div class="float-left">
                     <h3 class="card-title">Edit Share Information</h3>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$share->name}}" name="name" id="name" class="form-control">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$share->unit_price}}"  name="unit_price" id="unit_price" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$share->total_share}}"  name="total_share" id="total_share" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$share->min_total_share}}"  name="min_total_share" id="min_total_share" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$share->max_total_share}}"  name="max_total_share" id="max_total_share" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="min_buy_price" class="form-label">Minimum Buy Price</label>
                         <input type="text" value="{{$share->min_buy_price}}"  name="min_buy_price" id="min_buy_price" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
               </div>
               <div class="row mt-2">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-primary btn-theme" id="btn_share">Update Share</button>
                  </div>
               </div>
            </form>
         </div>
...
<script type="text/javascript">
   ...
   $("#share_form").submit(function(e) {
        ...
        $.ajax({
          url:'{{ route('webmaster.share.update') }}',
          method: 'post',
          data: $(this).serialize(),
          dataType: 'json',
