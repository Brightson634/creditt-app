...
@section('content')
    <div class="page-heading ">
        <div class="az-dashboard-nav">
            <nav class="nav">
                ...
                <a class="nav-link" data-toggle="tab" href="#loginlogs" role='tab' aria-controls="loginlogs"
                    aria-selected="false">Login Logs</a>
    ...
    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="text-center">
                                        @if ($staff->photo != null)
                                            <img alt="image" id="image_preview"
                                                src="{{ asset('assets/uploads/staffs/' . $staff->photo) }}"
                                    ...
                                    <div class="text-center">
                                        @if ($staff->signature != null)
                                            <img alt="image" id="signature_preview"
                                                src="{{ asset('assets/uploads/staffs/' . $staff->signature) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="title" id="title">
                                                <option {{ $staff->title == 'Mr' ? 'selected' : '' }} value="Mr">Mr
                                                </option>
                                                <option {{ $staff->title == 'Mrs' ? 'selected' : '' }} value="Mrs">Mrs
                                                </option>
                                                <option {{ $staff->title == 'Hon' ? 'selected' : '' }} value="Hon">Hon
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="gender" id="gender">
                                                <option {{ $staff->gender == 'Male' ? 'selected' : '' }} value="Male">
                                                    Male</option>
                                                <option {{ $staff->gender == 'Female' ? 'selected' : '' }} value="Female">
                                                    Female</option>
                                                <option {{ $staff->gender == 'Other' ? 'selected' : '' }} value="Other">
                                                    Others</option>
                                            </select>
                                            <span class="invalid-feedback"></span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="marital_status" id="marital_status">
                                                <option {{ $staff->marital_status == 'N/A' ? 'selected' : '' }}
                                                    value="N/A">N/A</option>
                                                <option {{ $staff->marital_status == 'Single' ? 'selected' : '' }}
                                                    value="Single">Single</option>
                                                <option {{ $staff->marital_status == 'Married' ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nin" id="nin" class="form-control"
                                                value="{{ $staff->nin }}" autocomplete="off">
                                            <span class="invalid-feedback"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_of_children" id="no_of_children"
                                                class="form-control" value="{{ $staff->no_of_children }}"
                                                autocomplete="off">
                                            <span class="invalid-feedback"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_of_dependant" id="no_of_dependant"
                                                class="form-control" value="{{ $staff->no_of_dependant }}"
                                                autocomplete="off">
                                            <span class="invalid-feedback"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="crbcard_no" id="crbcard_no" class="form-control"
                                                value="{{ $staff->crbcard_no }}" autocomplete="off">
                                            <span class="invalid-feedback"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="branch_id" id="branch_id">
                                                @foreach ($branches as $data)
                                                    <option {{ $data->id == $staff->branch_id ? 'selected' : '' }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="branchposition_id" id="branchposition_id">
                                                @foreach ($positions as $data)
                                                    <option {{ $data->id == $staff->branchposition_id ? 'selected' : '' }}
                                                        value="{{ $data->id }}">{{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="invalid-feedback"></span>
        ...
        <!--login logs-->
        <div class="tab-pane fade" id="loginlogs" role="tabpanel" aria-labelledby="loginlogs-tab">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
