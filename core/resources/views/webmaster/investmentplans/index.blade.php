            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  ...
                  <div class="float-right">
                     <a href="{{ route('webmaster.investmentplan.create') }}" class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-plus"></i> New Plan</a>
                  </div>
               </div>
                  ...
                  <table class="table table-sm mb-0">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                             <a href="#{{ route('webmaster.investmentplan.edit', $row->id) }}" class="btn btn-xs btn-dark"> <i class="far fa-edit"></i></a>
                           </td>
                        <tr>
                        @endforeach
                     </tbody>
