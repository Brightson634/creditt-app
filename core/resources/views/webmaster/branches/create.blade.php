               ...
               <div class="form-group row">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" name="branch_no" id="branch_no" class="form-control" value="{{ $branch_no }}" readonly>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  ...
                  <label for="is_main" class="col-sm-3 col-form-label">Is Main Branch</label>
                     <div class="col-sm-9 mt-2">
                           <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" id="no" name="is_main" class="custom-control-input" value="0" checked>
                              <label class="custom-control-label" for="no">NO</label>
                           </div>
                           <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" id="yes" name="is_main" class="custom-control-input" value="1">
