...
@section('content')
    <div class="az-content az-content-dashboard">
        <div class="container">
            <div class="col-xl-12 mx-auto bg-white p-4">
                <h2 class="az-content-title">Edit Package: {{ $package->name }}</h2>
                <form action="{{ route('webmaster.packages.update', $package) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <!-- Package Name -->
                        ...
                        <div class="col-lg-12">
                            ...
                            @foreach ($modules as $module)
                                <div class="form-group">
                                    ...
                                    {{-- Uncomment to enable module limits
                                    <div class="input-group mt-2 mb-3">
                                        ...
                                        <input type="number"
                                               ...
                                               value="{{ old('modules.' . $loop->index . '.limits.max_' . $module . '_accounts', $package->modules->where('module_name', $module)->first()->limits['max_' . $module . '_accounts'] ?? '') }}"
                                               autocomplete="off">
