            ...
            <div class="card-body">
                <div class="clearfix mb-3">
                    ...
                    <div class="float-right">
                        <a href="{{ route('webmaster.accounttypes') }}"
                            class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-eye"></i> View Account Types</a>
                    </div>
                </div>
                <form action="#" method="POST" id="account_form">
                    ...
                    <div class="form-group row mt-4">
                        <div class="col-sm-9">
                            <button type="submit" class="btn btn-primary btn-theme" id="btn_account">Add Account Type</button>
                        </div>
                    </div>
                </form>
            </div>
