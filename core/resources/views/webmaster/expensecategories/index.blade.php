            ...
            <div class="float-right">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="#" method="POST" id="category_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-sm btn-theme" id="btn_category">Add Category</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card mt-4">
                    <h6 class="card-title">
                        ...
                        <div class="float-right">
                            @can('add_category')
                                <button type="button" class="btn btn-sm btn-dark btn-theme" data-toggle="modal" data-target="#categoryModel">
                                ...
                                @foreach ($categories as $row)
                                    ...
                                    @foreach ($subcategories as $subcat)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $expense_account_display = $accounts_lookup[$subcat->expense_account] ?? $subcat->expense_account;
                                                @endphp
