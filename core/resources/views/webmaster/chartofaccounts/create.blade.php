            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  ...
                  <div class="float-right">
                     <a href="{{ route('webmaster.chartofaccounts') }}" class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-eye"></i> View Chart Of Accounts</a>
                  </div>
               </div>
               ...
               <div class="row mt-2">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-primary btn-theme" id="btn_account">Add Chart of Account</button>
                  </div>
               </div>
            </form>
         </div>
