                ...
                <div class="card-body">
                    <div class="clearfix mb-3">
                        ...
                        <div class="float-right">
                            <a href="{{ route('webmaster.loanproduct.create') }}" class="btn btn-dark btn-sm btn-theme"> <i
                                    class="fa fa-plus"></i> New Loan Product</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($loanproducts as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endcan
                                                @can('delete_loan_product')
                                                    <form action="{{ route('webmaster.loanproduct.destroy', $row->id) }}"
