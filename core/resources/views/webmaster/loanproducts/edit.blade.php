            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  <div class="float-left">
                     <h3 class="card-title">Edit Loan Product Information</h3>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$loanproduct->name}}" name="name" id="name" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <input type='hidden' value="{{$loanproduct->id}}" name='id'>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="min_amount" class="form-label">Minimum Amount:</label>
                        <input type="number" value="{{$loanproduct->min_amount}}" name="min_amount" id="min_amount" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="number" value="{{$loanproduct->max_amount}}" name="max_amount" id="max_amount" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
               </div>
                <div class="form-group row">
                  ...
                  <div class="col-md-4">
                     ...
                     <select class="form-control" name="duration" id="duration">
                           ...
                           <option value="day" @if($loanproduct->duration == 'day') selected @endif>Daily</option>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type='number' value="{{$loanproduct->cust_acc_balance}}" class='form-control' name='cust_acc_balance' id='cust_acc_balance' />
               ...
               <div class="row mt-2">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-primary btn-theme" id="btn_loanproduct">Update Loan Product</button>
                  </div>
               </div>
            </form>
         </div>
...
<script type="text/javascript">
   ...
   $("#loanproduct_form").submit(function(e) {
        e.preventDefault();
        $("#btn_loanproduct").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span>Updating');
        $("#btn_loanproduct").prop("disabled", true);
        $.ajax({
          url:'{{ route('webmaster.loanproduct.update') }}',
          method: 'post',
          data: $(this).serialize(),
          dataType: 'json',
          success: function(response){
            if(response.status == 400){
              ...
              $("#btn_loanproduct").html('Update Loan Product');
