                ...
                <div class="card-body">
                    <div class="clearfix mb-3">
                        ...
                        <div class="float-right">
                            @can('view_expenses')
                                <a href="{{ route('webmaster.expenses') }}" class="btn btn-dark btn-sm btn-theme"> <i
                    ...
                    <form action="#" method="POST" id="expense_form">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary btn-theme" id="btn_expense">Add
                                    Expense</button>
                            </div>
                        </div>
                    </form>
