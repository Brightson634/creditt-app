            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  ...
                  <div class="float-right">
                     @can('view_expenses')
                     <a href="{{ route('webmaster.expense.update') }}" class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-eye"></i> View Expenses</a>
                     @endcan
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{$expense->name}}" class="form-control" placeholder='Provide name'>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <select class="form-control" id="subcategory_id" name="subcategory_id">
                           ...
                           <optgroup label="{{ $category->name }}" @if($expense->category_id == $category->id) selected @endif>
                           @php
