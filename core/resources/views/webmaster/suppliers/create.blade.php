            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  ...
                  <div class="float-right">
                     <a href="{{ route('webmaster.suppliers') }}" class="btn btn-sm btn-theme"> <i class="fa fa-eye"></i> View Suppliers</a>
                  </div>
               </div>
               ...
               <div class="row mt-2">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-theme" id="btn_supplier">Add Supplier</button>
                  </div>
               </div>
            </form>
         </div>
