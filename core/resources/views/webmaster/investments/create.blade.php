            ...
            <div class="card-body">
               <div class="clearfix mb-3">
                  ...
                  <div class="float-right">
                     <a href="{{ route('webmaster.investments') }}" class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-eye"></i> View Investments</a>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="investment_no" id="investment_no" class="form-control" value="{{ $investment_no }}" readonly>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <select class="form-control" name="investor_type" id="investor_type">
                           ...
                           <option value="member">Member Investor</option>
                           <option value="nonmember">Non Member Investor</option>
                        </select>
                        ...
                        <div class="input-group">
                          <select class="form-control" name="investor_id" id="investor_id">
                           ...
                           <div class="input-group-append">
                            <a href="javascript:void(0)" class="btn btn-sm btn-info" data-toggle="modal" data-target="#investorModel"><i class="fa fa-plus"></i></a>
                           </div>
                           <span class="invalid-feedback"></span>
                        </div>
                     </div>
               ...
               <div class="row">
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="investment_amount" id="investment_amount" class="form-control">
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" name="investment_period" id="investment_period" class="form-control">
                          <div class="input-group-append">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label for="roi_amount" class="form-label">Investment ROI</label>
                         <input type="text" name="roi_amount" id="roi_amount" class="form-control" readonly>
                        <span class="invalid-feedback"></span>
                     </div>
                  </div>
                  <div class="col-md-4">
               ...
               <div class="row mt-2">
                  <div class="col-sm-9">
                     <button type="submit" class="btn btn-primary btn-theme" id="btn_investment">Add Investment</button>
                  </div>
               </div>
            </form>
         </div>
                        ...
                        <div class="modal-body">
                           ...
                           <form action="#" method="POST" id="gmember_form">
                              ...
                              <div class="form-group">
                                 ...
                                 <button type="submit" class="btn btn-sm btn-theme" id="btn_gmember">Add Investor</button>
                              </div>
                           </form>
                        </div>
                     </div>
...
<script type="text/javascript">
   ...
   $("#investment_form").submit(function(e) {
        e.preventDefault();
        $("#btn_investment").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span> Adding');
        $("#btn_investment").prop("disabled", true);
        $.ajax({
          url:'{{ route('webmaster.investment.store') }}',
          method: 'post',
          data: $(this).serialize(),
          dataType: 'json',
            ...
            if(response.status == 400){
              ...
              $("#btn_gmember").prop("disabled", false);
                ...
                $.each(newInvestors, function(index, investor) {
                  var option = '<option value="' + investor.id + '">' + investor.name + '</option>';
                  $('#investor_id').append(option);
                });
                 $('#investor_id').val(response.investors[response.investors.length - 1].id);
