                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" id="investment_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="member_id" id="member_id">
                                            ...
                                            @foreach ($members as $data)
                                                <option value="{{ $data->id }}">{{ $data->fname }} {{ $data->lname }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <span class="invalid-feedback"></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="investment_period" id="investment_period"
                                                class="form-control">
                                            <div class="input-group-append">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="roi_amount" id="roi_amount" class="form-control"
                                            readonly>
                                        <span class="invalid-feedback"></span>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-sm-9">
                                    <button type="submit" class="btn btn-primary btn-theme" id="btn_investment">Add
                                        Investment</button>
                                </div>
                            </div>
                        </form>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('#investmentplan_id, #investment_amount, #investment_period').on('input', function() {
            ...
            let formatted_end_date = end_date.getFullYear() + '-' + (end_date.getMonth() + 1).toString().padStart(2,
                ...
                success: function(response) {
                    if (response.status == 400) {
                        ...
                        $.each(newInvestors, function(index, investor) {
                            var option = '<option value="' + investor.id + '">' + investor
                                .name + '</option>';
