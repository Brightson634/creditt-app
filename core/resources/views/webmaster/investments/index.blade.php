...
<div class="page-heading ">
   ...
   <div class="az-dashboard-nav">
      <nav class="nav">
         ...
         <a class="nav-link active" data-toggle="tab" href="#memberinvestments" role='tab' aria-controls="statements">Member</a>
...
<div class="tab-content" id="myTabContent">
   <!--member-->
   <div class="tab-pane fade show active" id="memberinvestments" role="tabpanel" aria-labelledby="memberinvestments-tab">
      <div class="row">
