        ...
        <section>
            ...
            <section>
                ...
                <div id="collateralContainer">
                    @forelse ($loanCollaterals as $index => $collateral)
                        <div class="card shadow-sm p-3 mb-4 rounded collateral-item" data-index="{{ $index }}">
                            <h5 class="card-title">Collateral {{ $index + 1 }}</h5>
                            <div class="form-group">
                    ...
                    @empty
                        <div class="card shadow-sm p-3 mb-4 rounded collateral-item" data-index="0">
                            ...
                            <div class="form-group">
                                <label for="collateralItem_0">Collateral Item</label>
