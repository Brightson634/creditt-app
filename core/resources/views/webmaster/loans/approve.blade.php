            ...
            <div class="row mt-4">
               <div class="col-md-12">
                  ...
                  <form action="#" method="POST" id="approve_form">
                           ...
                           <div class="form-group">
                              <div class="mt-2">
                                 <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="approve" name="status" class="custom-control-input" value="3" checked>
                                    <label class="custom-control-label" for="approve">APPROVE LOAN</label>
                                 </div>
                                 <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="reject" name="status" class="custom-control-input" value="4">
                     ...
                     <div class="row">
                        <div class="col-sm-9">
                           <button type="submit" class="btn btn-indigo btn-theme" id="btn_approve">Update Status</button>
                        </div>
                     </div>
                  </form>
               </div>
...
<script type="text/javascript">
   ...
   $("#approve_form").submit(function(e) {
        e.preventDefault();
        $("#btn_approve").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span><span class="sr-only">Loading...</span> Updating');
