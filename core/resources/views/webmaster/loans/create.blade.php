                ...
                <div class="card-body">
                    <div class="clearfix mb-3">
                        ...
                        <div class="float-right">
                            <a href="{{ route('webmaster.loans') }}" class="btn btn-dark btn-sm btn-theme"> <i class="fa fa-eye"></i>
                                View Loans</a>
                        </div>
                    </div>
                    <form action="{{ route('webmaster.loan.store') }}" method="POST" id="loan_form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="interest_amount" id="interest_amount" class="form-control"
                                        readonly>
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 cashDiv" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cash_amount" id="cash_amount" class="form-control"
                                        readonly>
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 loanDiv" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="loan_principal" id="loan_principal" class="form-control"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary btn-theme" id="btn_loan">Add Loan</button>
                            </div>
                        </div>
                    </form>
                </div>
