                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="loan_type" id="loan_type">
                                                ...
                                                <option value="individual"
                                                    @if ($loan->loan_type == 'individual') selected @endif>Individual Loan
                                                </option>
                                                <option value="group" @if ($loan->loan_type == 'group') selected @endif>
                                                    Group Loan</option>
                                            </select>
                                            ...
                                            <select class="form-control loan_member_id" name="loan_member_id"
                                                ...
                                                @foreach ($members as $data)
                                                    <option value="{{ $data->id }}"
                                                        @if ($loan->member_id == $data->id) selected @endif>
                                                        {{ $data->fname }} -
                                                        {{ $data->lname }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control loanProduct" name="loanproduct_id"
                                                ...
                                                @foreach ($loanproducts as $data)
                                                    <option value="{{ $data->id }}"
                                                        @if ($loan->loanproduct_id == $data->id) selected @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="gracePeriodType"
                                                    ...
                                                    <option value="days"
                                                        @if ($loan->grace_period_in == 'days') selected @endif>Days</option>
                                                    <option value="weeks"
                                                        @if ($loan->grace_period_in == 'weeks') selected @endif>Weeks</option>
                                                    <option value="months"
                                                        @if ($loan->grace_period_in == 'months') selected @endif>Months</option>
                                                </select>
                                                <input type="number" class="form-control" id="gracePeriodValue"
                                                    name="grace_period_value" value='{{ $loan->grace_period }}'
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" data-toggle="select2"
                                                ...
                                                @foreach ($fees as $data)
                                                    <option value="{{ $data->id }}"
                                                        @if (in_array($data->id, $loanFees)) selected @endif>
                                                        {{ $data->name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="invalid-feedback"></span>
                                ...
                                <select class="form-control memberSelection" style="width: 75%" name="member_id[]"
                                    ...
                                    @foreach ($members as $data)
                                        @if ($data->member_type == 'individual')
                                            <option value="{{ $data->id }}"
                                                @if (in_array($data->id, $guarantors)) selected @endif>{{ $data->fname }} -
                                                {{ $data->lname }}</option>
                                        @endif
